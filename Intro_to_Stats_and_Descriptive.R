...
ggplot(painters, aes(x=School, fill = School)) + geom_bar(colour = "black") # Consult the ggplot2() package for more information on this. ggplot() is a standard for data visualisation.
